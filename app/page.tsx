        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center max-w-md mx-auto p-8">
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-6 text-left">
              ...
              <p className="text-muted-foreground mb-4">Please set up your database to get started:</p>
              <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
                <li>Create a PostgreSQL database (e.g., on Neon)</li>
                <li>
                  Set the <code className="bg-muted px-1 rounded">DATABASE_URL</code> environment variable
                </li>
                <li>
